// various implementations of this algorithm available at   http://tartarus.org/~martin/ PorterStemmer/ index.html
// adapted from java implementation 
  ...
  if (this._isArray(docFeatures)) {
    ...
    while(i--) {
      ...
      if (docFeatures[i]) {
         ...
         * feature frequencies in the document body.
         *
